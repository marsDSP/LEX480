...
#ifndef LEX480_DATT_DIFFUSOR_H
#define LEX480_DATT_DIFFUSOR_H
#include <random>
...
namespace MarsDSP::Math::DelayLineInterpolationTypes
{
    struct None;
}
 ...
 */
    ...
    template<typename FloatType,
        int nChannels,
        typename DelayInterpType = Math::DelayLineInterpolationTypes::None,
    ...
    public:
        ...
        template<typename DiffuserChainConfig = DiffuserChainEqualConfig, typename DiffuserConfig =
            DefaultDiffuserConfig>
        void prepare(double sampleRate);
        ...
        /** Processes a set of channels */
        const FloatType *process(FloatType *data) noexcept
        {
