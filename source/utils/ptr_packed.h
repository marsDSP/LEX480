...
#ifndef LEX480_PTR_PACKED_H
#define LEX480_PTR_PACKED_H
...
namespace MarsDSP::Utils
{
    ...
    {
        static_assert (alignof (T) >= 8, "ptr_packed implementation requires pointers that are aligned to 8 bytes or greater!");
